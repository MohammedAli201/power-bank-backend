...
var WaafiPayAPI = function (apiKey, apiUserId, merchantUid, { testMode, apiMode }) {
    ...
    var apiPurchase = function (options, callback) {
        ...
        if (options.browserInfo === undefined) throw new Error("Unique browserInfo is not provided.");
        ...
        serviceParams.browserInfo = options.browserInfo;
        ...
        postData.serviceName = 'API_PURCHASE';
